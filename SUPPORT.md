...
Use GitHub Issues for reproducible bugs and scoped feature requests. Use GitHub Discussions
for design questions and integration guidance when Discussions are enabled.

Security vulnerabilities must follow [SECURITY.md](SECURITY.md) and must not be reported in
a public issue.
